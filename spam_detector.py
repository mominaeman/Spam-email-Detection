...
class SpamDetector:
    def __init__(self, delta=1.0):
        self.delta = delta
        self.trained = False
    def train(self, ham_path, spam_path):
        ...
        self.spam_bagOfWords, self.ham_bagOfWords = bagOfWords_genarator(self.all_uniqueWords, spam_trainWords, ham_trainWords)
        self.smoothed_spamBOW, self.smoothed_hamBOW = smoothed_bagOfWords(self.all_uniqueWords, self.spam_bagOfWords, self.ham_bagOfWords, self.delta)
        ...
        self.spam_condProb = spam_condProbability(self.all_uniqueWords, self.spam_bagOfWords, self.smoothed_spamBOW, self.delta)
        self.ham_condProb = ham_condProbability(self.all_uniqueWords, self.ham_bagOfWords, self.smoothed_hamBOW, self.delta)
        self.trained = True
